...
furniture3 = Furniture.create!(name:"Alma", material: "Bois", color: "Vert livid", type_of_furniture: "Bibliothèque", varnish: "", varnish_brand: "", teint: "", paint_brand: "Little Green", date_of_manufacture: "", description: "Bibliothèque sur mesure Alma 📚📚
...
#varnish: "", varnish_brand: "", teint: "Chêne - Libéron", paint_brand: "Pure & Paint", date_of_manufacture: "")

furniture10 = Furniture.create!(name:"Christina", material: "Bois", color: "Blanc Albâtre", type_of_furniture: "Coffre", varnish: "", varnish_brand: "", teint: "", paint_brand: "Libéron", date_of_manufacture: "", description: "À l'atelier c'est un vieux coffre qui est passé entre nos mains cette semaine.
...
#varnish: "", varnish_brand: "", teint: "Bois", paint_brand: "Libéron", date_of_manufacture: "")

furniture11 = Furniture.create!(name:"Simone", material: "Bois - pin", color: "Rose boréal", type_of_furniture: "Commode", varnish: "Mat", varnish_brand: "Libéron", teint: "", paint_brand: "Envie", date_of_manufacture: "", description: "Aujourd'hui c'est une commode qui est passée à l'atelier pour un relooking.
...
furniture12 = Furniture.create!(name:"Nona", material: "Bois", color: "Noire", type_of_furniture: "Table basse", varnish: "Bistrot", varnish_brand: "Libéron", teint: "", paint_brand: "", date_of_manufacture: "", description: "Aujourd'hui nous ne parlerons pas de restauration mais de fabrication avec cette commande qui sort de l'atelier.
...
furniture16 = Furniture.create!(name:"Jade", material: "Bois - pin", color: "Gris bleu", type_of_furniture: "Bahut", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "En ce mois janvier, l'atelier Plinguet vous présente ses voeux ainsi que ce nouveau bijou. Jade est un bahut avec deux portes qui a bien souffert durant son passé. De nombreux petits habitants xylophages ont apprécié son bois. L'atelier a passé beaucoup de temps sur l'assainissement du meuble et sa reconstruction. De nombreuses heures ont été passés à traiter et réparer les dégâts causés par les vrillettes.
Aujourd'hui, nous avons un magnifique bahut à deux portes, peint dans un gris bleu de chez @farrowandballfr , avec un plateau et un intérieur en pin qui font ressortir cette magnifique teinte. De nouvelles poignées terminent cette restauration pour parfaire le résultat.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "")
...
furniture18 = Furniture.create!(name:"Paulina", material: "Bois", color: "Vert Rivage", type_of_furniture: "Meuble box tv", varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "", description: "A l'atelier cette semaine nous avons cherché pour un client un tout petit meuble pour cacher sa box internet. Il y avait deux contraintes à respecter pour cette commande : la taille, pas plus de 40 cm de large et de profondeur, et l'ouverture, la box a besoin d'air pour ne pas surchauffer.
...
furniture19 = Furniture.create!(name:"Philippa", material: "Bois", color: "", type_of_furniture: "Commode", varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "", description: "Cette commode est arrivée à l'atelier dans un bien piteux état. Initialement pourvue d'un rose bonbon plus qu'écaillé, d'un seul bouton central par tiroir et surtout de long pieds sculptés style Louis XV, nous avons décidé de changer totalement son style pour en faire une commode pour enfant.
...
furniture22 = Furniture.create!(name:"Chloé", material: "Bois", color: "Bleu Hague blue", type_of_furniture: "Enfilade", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "La semaine dernière, l'atelier Plinguet a eu le plaisir de travailler à Paris sur une superbe enfilade scandinave des années 60. Le propriétaire de ce meuble l'avait chiné sur le site Selency qui regorge de pépites pour que nous le restaurions à son goût. De nombreuses heures de travail ont permis de lui donner une seconde jeunesse. Un papier peint intissé au motif floral dans les parties secrétaires ainsi que le bleu Hague Blue de chez Farrow&ball ont permis de rapporter cette sublime enfilade dans notre siècle ")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "2022-03-21")

furniture23 = Furniture.create!(name:"Eva", material: "Bois", color: "Bleu Nîmes", type_of_furniture: "Buffet", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "La semaine dernière, l'atelier Plinguet a travaillé sur la restauration d'un buffet Parisien vintage. Apres un décapage intensif pour le dévêtir de sa peinture glycéro blanche, puis un traitement du bois, le buffet arbore dorénavant un magnifique bleu de Nimes de chez Farrow&Ball, qui est en réalité un sublime gris/bleu.
...
furniture28 = Furniture.create!(name:"Victoria", material: "Bois", color: "", type_of_furniture: "Commode", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Depuis dix jours, l'atelier Plinguet s'est délocalisé à Paris pour restaurer des meubles directement chez ses clients. La commode Victoria était dans un sale état à notre arrivée. Quelques réparations de tiroirs après, un gros travail de ponçage et de peinture, suivis d'un changement de boutons ont permis de rendre cette commode basique beaucoup plus moderne!")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture29 = Furniture.create!(name:"Emma", material: "Bois", color: "", type_of_furniture: "Meuble à chaussure", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Cette semaine, c'est le deuxième meuble à chaussures Emma qui était disponible à l'adoption qui quitte l'atelier. Ce meuble recherché de style pierre Guariche reste dans la région puisqu'il rejoint une bergerie Landaise. Transformé en commode pour une chambre d'enfant, ses tons dégradés s'harmonisent parfaitement avec la déco de notre client.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture30 = Furniture.create!(name:"Holly", material: "Bois", color: "Vert Céladon", type_of_furniture: "Semainier", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "L'Atelier Plinguet s'exporte aussi. À la demande d'une cliente américaine habitant la région Landaise, nous avons refait 2 semainiers en vert céladon avec quelques dorures pour leur donner un look rétro. Souhaitant en faire des tables de nuit, les pieds ont été rabaissés pour que ces deux semainiers puissent prendre place de chaque côté du lit.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture31 = Furniture.create!(name:"Camille", material: "Cuivre & Bois", color: "Blanc écru", type_of_furniture: "Console", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Voici une nouvelle création de l'atelier. Cette semaine, nous avons travaillé sur une superbe console en cuivre et bois de couleur blanc écru. Son design élégant et épuré nous plait vraiment beaucoup! Bonne nouvelle cette pièce est disponible à l'adoption.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture32 = Furniture.create!(name:"Louise", material: "Bois", color: "", type_of_furniture: "Meuble de toilette", varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "", description: "Voici une nouvelle pièce sortie de l'atelier. Cet ancien meuble de toilette utilisé dans les années 1900 est arrivé à l'atelier la semaine dernière. Après pas mal d'heures de travail, il est reparti pour une deuxième jeunesse. Bonne nouvelle, Louise est disponible à l'adoption. En table d'appoint, bureau ou meuble de salle de bain, il trouvera une place dans n'importe quel intérieur.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture33 = Furniture.create!(name:"Philippa", material: "Bois", color: "Bleu velours", type_of_furniture: "Semainier", varnish: "", varnish_brand: "", teint: "Chêne doré", paint_brand: "", date_of_manufacture: "", description: "Aujourd'hui à l'atelier Plinguet, un client nous a confié la restauration d'un semainier espagnol.
...
furniture35 = Furniture.create!(name:"Emma", material: "Bois", color: "Vert", type_of_furniture: "Meuble à chaussures / commode", varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "", description: "Cette pépite dénichée il y a deux semaines est un superbe meuble à chaussures très recherché de style pierre Guariche. Il peut également servir de petite commode. Arrivé dans un état assez catastrophique à l'atelier, il a fallu travailler sans relâche pour lui offrir une deuxième jeunesse. Revêtu d'un très joli vert, ce meuble à 4 tiroirs et poignées dorées apportera une touche design à votre intérieur.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture36 = Furniture.create!(name:"Armelle", material: "Bois", color: "Bleu Cobalt", type_of_furniture: "Table", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "À la demande d'une cliente, l'atelier Plinguet a transformé un vieux meuble à machine à coudre en petite table. Son bleu cobalt et ses détails en laiton, donnent du chic à ce basique qui a trouvé sa place dans un appartement bordelais.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture37 = Furniture.create!(name:"Ava", material: "Bois", color: "Vert d'eau", type_of_furniture: "Coffre à jouets", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Restauration : Coffre à jouets entièrement en bois, restauré dans les tons vert d'eau et bois pour un rendu doux et naturel.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture38 = Furniture.create!(name:"Suzanne", material: "Bois", color: "Vert", type_of_furniture: "Mini-bar", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Restauration : bar vintage des années 60 sur roulettes, restauré et remis au goût du jour dans deux tons de vert.")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "")

furniture39 = Furniture.create!(name:"Anna", material: "Bois", color: "Bleu nuit", type_of_furniture: "Commode", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Restauration : Commode restaurée dans les tons bleu nuit avec poignées cuivrées pour un design chic et épuré")
#varnish: "", varnish_brand: "", teint: "", paint_brand: "", date_of_manufacture: "", poignées : "Cuivrées")

furniture40 = Furniture.create!(name:"Eliza", material: "Cuivre & Bois - Pin", color: "", type_of_furniture: "Console", varnish: "", varnish_brand: "", teint: "", paint_brand: "Farrow & Ball", date_of_manufacture: "", description: "Création de l'atelier plinguet pour une commande client.
...
nona4 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1708930058/atelier-plinguet/mona-4-table-basse_lyhtgv.png'
...
eva_before = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706716687/atelier-plinguet/eva-before-1-commode_v8zye9.png'
...
philippa_semainier1 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1705595697/atelier-plinguet/philippa-1-semainier_rtrhda.png'
philippa_semainier2 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1705595698/atelier-plinguet/philippa-2-semainier_duo7hf.png'
philippa_semainier3 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706622664/atelier-plinguet/philippa-3-semainier_gvoemk.png'
philippa_semainier4 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706622664/atelier-plinguet/philippa-4-semainier_enip8c.png'
...
emma2_1 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1705595719/atelier-plinguet/emma2-1-meuble-chaussure_sndmld.png'
emma2_2 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706622665/atelier-plinguet/emma2-3-meuble-chaussure_gq6jxw.png'
emma2_3 = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706622664/atelier-plinguet/emma2-4-meuble-chaussure_gv4qgy.png'
emma2_old = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1705595721/atelier-plinguet/emma2-2-meuble-chaussure_x4tz5a.png'
...
ava_before = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1708929191/atelier-plinguet/ava-before-1_dhxd2w.png'
...
victoria1_old = 'https://res.cloudinary.com/dnqkzzqga/image/upload/v1706622659/atelier-plinguet/victoria-01-commode_yir3ho.png'
...
#Mona
furniture12.photos.attach(io: URI.open(nona1), filename: 'nona-1-table-basse.jpg', content_type: "image/jpg" )
furniture12.photos.attach(io: URI.open(nona2), filename: 'nona-2-table-basse.jpg', content_type: "image/jpg" )
furniture12.photos.attach(io: URI.open(nona3), filename: 'nona-3-table-basse.jpg', content_type: "image/jpg" )
furniture12.photos.attach(io: URI.open(nona4), filename: 'nona-4-table-basse.jpg', content_type: "image/jpg" )
furniture12.save
puts "Mona : ok"
...
#Pauline
furniture18.photos.attach(io: URI.open(pauline1), filename: 'paulina-1-meuble-box.jpg', content_type: "image/jpg" )
...
furniture23.photos.attach(io: URI.open(eva_before), filename: 'eva_before-1-buffet.jpg', content_type: "image/jpg" )
furniture23.save
puts "Eva : ok"
...
#Louisa
furniture25.photos.attach(io: URI.open(louisa1), filename: 'louisa-1-commode.jpeg', content_type: "image/jpeg" )
furniture25.photos.attach(io: URI.open(louisa2), filename: 'louisa-2-commode.jpeg', content_type: "image/jpeg" )
furniture25.photos.attach(io: URI.open(louisa3), filename: 'louisa-3-commode.jpeg', content_type: "image/jpeg" )
furniture25.save
puts "Louisa : ok"
...
#Prune
furniture27.photos.attach(io: URI.open(prune1), filename: 'prune-1-bureau.jpeg', content_type: "image/jpeg" )
furniture27.photos.attach(io: URI.open(prune2), filename: 'prune-2-bureau.jpeg', content_type: "image/jpeg" )
furniture27.photos.attach(io: URI.open(prune3), filename: 'prune-3-bureau.jpeg', content_type: "image/jpeg" )
furniture27.photos.attach(io: URI.open(prune4), filename: 'prune-4-bureau.jpeg', content_type: "image/jpeg" )
furniture27.photos.attach(io: URI.open(prune5), filename: 'prune-5-bureau.jpeg', content_type: "image/jpeg" )
furniture27.save
puts "Prune : ok"
...
#Philippa-semainier
furniture33.photos.attach(io: URI.open(philippa_semainier1) ,filename: 'philippa_semainier1.png', content_type: "image/png" )
furniture33.photos.attach(io: URI.open(philippa_semainier2), filename: "philippa_semainier2.png", content_type: "image/png" )
furniture33.photos.attach(io: URI.open(philippa_semainier3), filename: "philippa_semainier3.png", content_type: "image/png" )
furniture33.photos.attach(io: URI.open(philippa_semainier4), filename: "philippa_semainier4.png", content_type: "image/png" )
furniture33.save
puts "Philippa : ok"
...
#Emma2
furniture35.photos.attach(io: URI.open(emma2_1), filename: 'emma2_1-meuble-chaussure.png', content_type: "image/png" )
furniture35.photos.attach(io: URI.open(emma2_2), filename: 'emma2_2-meuble-chaussure.png', content_type: "image/png" )
furniture35.photos.attach(io: URI.open(emma2_3), filename: 'emma2_3-meuble-chaussure.png', content_type: "image/png" )
furniture35.photos.attach(io: URI.open(emma2_old), filename: 'emma2_old-meuble-chaussure.png', content_type: "image/png" )
furniture35.save
...
furniture36.photos.attach(io: URI.open(armelle3), filename: 'armelle-2-table.png', content_type: "image/png" )
furniture36.photos.attach(io: URI.open(armelle4), filename: 'armelle-2-table.png', content_type: "image/png" )
furniture36.save
puts "Armelle ok"
...
#Eliza
furniture40.photos.attach(io: URI.open(eliza1), filename: 'eliza-1-console.jpeg', content_type: "image/jpeg" )
furniture40.photos.attach(io: URI.open(eliza2), filename: 'eliza-2-console.jpeg', content_type: "image/jpeg" )
